...
#include "turbulentTwoPhase0TransportModels.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

makeBaseTurbulenceModel
(
    geometricOneField,//change geometricOneField to volScalarField;
    volScalarField,//change geometricOneField to volScalarField;
    incompressibleTwoPhase0TurbulenceModel,//TwoPhase0 added
    IncompressibleTwoPhase0TurbulenceModel,//TwoPhase0 added
    transportModel
);
...
#include "DampingRNGkEpsilon.H"
makeRASModel(DampingRNGkEpsilon);
